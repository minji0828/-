...
public class application01 {
    public  static void main(String[] args) {
        ...
        *
        * 형변환
        * 형변환은 프로그래밍에서 데이터 타입을 다른 데이터 타입으로 변환하는 과정을 의미하낟.
        * 형변환은 두가지 주요 방식으로 나눌 수 이쓴데 암시적 형변환관 명시적 형변환이다.
        *
         */
        /*
        * 암시적 형변환
        * 작은 범위의 데이터 타입에서 큰 범위의 데이터 타입으로 자동으로 변환되는 과정을 의미한다.
        * (int ->long)이 경우 데이터 손실이 발생하지 않ㄴ느다.
        *
         */
        int intVal = 100; // 4byte
        long longVal = intVal; // 8byte
